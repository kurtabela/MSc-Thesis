...
with open("test_dataset/data/actual_test." + SRC_LANG, "w+", encoding="utf-8") as actual_test:
    with open("test_dataset/data/actual_preds." + TGT_LANG, "w+", encoding="utf-8")  as actual_preds:
        for path in pathlist:
            ...
            with open("test_dataset/data/predictions" + pred_file_num + "." + TGT_LANG, 'r', encoding="utf-8") as pred_file:
                with open("test_dataset/data/test" + pred_file_num + "." + SRC_LANG, "r", encoding="utf-8") as test_file:
                    test_file_lines = []
...
with open("test_dataset/data/actual_test." + SRC_LANG, "r+", encoding="utf-8") as actual_test:
...
gold_reference="test_dataset/data/actual_test." + SRC_LANG

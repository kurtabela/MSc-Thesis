...
#
#        with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions' + str(nValue) + '.' + TGT_LANG, "a+",
#          encoding="utf-8") as w:
#
#            for xfile in xfilelst:
#                print("PRINTING TO " + os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions' + str(nValue) + '.' + TGT_LANG)
...
#             text_to_return = self.tokenizers.ic.detokenize(output)[0]  # shape: ()

#             tokens = self.tokenizers.ic.lookup(output)[0]
#         else:
#             # output.shape (1, tokens)
...
# ground_truth = "Good morning"
# sentence = "Góðan daginn"
...
# # sentence = "this is the first problem i've ever done."
...
def run(task_id, i, too_big_predictions, lengthOfExamples, test_tgt_lang):
    ...
    with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions' + str(task_id) + '.' + TGT_LANG, "a+",
              encoding="utf-8") as w:
        with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/actualTest' + str(task_id) + '.' + TGT_LANG, "a+", encoding="utf-8") as wTooBig:
            ...
            while (i+too_big_predictions + batch_size) <= lengthOfExamples-1:
                ...
                if SRC_LANG == "ic":
                    for curr_index, ic in enumerate(ic_list[i+too_big_predictions: i +too_big_predictions + batch_size]):
                ...
                if to_predict:
                    ...
                    print("PRINTING TO " + os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions' + str(task_id) + '.' + TGT_LANG)
...
if __name__ == '__main__':
    ...
    toWrite = []
    data_in = []
    with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/test' + str(args.task_id) + '.' + SRC_LANG, "r+",
              encoding="utf-8") as f:
        data_in = f.read().split('\n')
        
    with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/test' + str(args.task_id) + '.' + TGT_LANG, "r+",
              encoding="utf-8") as f:
    ...
    open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions' + str(args.task_id) + '.' + TGT_LANG, "w+").close()
    open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/actualTest' + str(
            args.task_id) + '.' + TGT_LANG, "w+").close()

    with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/predictions'+ str(args.task_id) + '.' + TGT_LANG, "r+",
              encoding="utf-8") as fp:
        i = len(fp.readlines())
    print('Total lines so far:', i)

    open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/actualTest' + str(args.task_id) + '.' + TGT_LANG,
             "w+").close()

    with open(os.path.dirname(os.path.realpath("__file__")) + '/ic_en_dataset/data/actualTest' + str(args.task_id) + '.' + TGT_LANG, "r+",
              encoding="utf-8") as fp:

...
# +
pathlist = Path("ic_en_dataset/data/").glob('**/predictions*.' + TGT_LANG)
with open("ic_en_dataset/data/actual_test." + TGT_LANG, "w+", encoding="utf-8") as actual_test:
    with open("ic_en_dataset/data/actual_preds." + TGT_LANG, "w+", encoding="utf-8")  as actual_preds:
        for path in pathlist:
            print(path)
            line_count = 0
            pred_file_num = str(path)[-5:-3]
            with open("ic_en_dataset/data/predictions" + pred_file_num+ "." + TGT_LANG, 'r', encoding="utf-8") as pred_file:
                with open("ic_en_dataset/data/test" + pred_file_num + "." + TGT_LANG, "r", encoding="utf-8") as test_file:
                    test_file_lines = []
...
with open("ic_en_dataset/data/actual_test." + TGT_LANG, "r+", encoding="utf-8") as actual_test:
    with open("ic_en_dataset/data/actual_preds." + TGT_LANG, "r+", encoding="utf-8")  as actual_preds:
        line_count = 0

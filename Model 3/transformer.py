...
# %%
model_for_export = tfmot.sparsity.keras.strip_pruning(transformer_test)

# %%


pruned_keras_file = 'pruned_keras_file_' + SRC_LANG + "_" + TGT_LANG + '.h5'
...
pruned_tflite_file = 'pruned_tflite_file_' + SRC_LANG + "_" + TGT_LANG + '.tflite'
...
quantized_and_pruned_tflite_file = 'quantized_and_pruned_' + SRC_LANG + "_" + TGT_LANG + '.tflite'
...
def get_gzipped_model_size(file):
  # Returns size of gzipped model, in bytes.
    ...
    zipped_file = 'model_' + SRC_LANG + "_" + TGT_LANG + '.zip'
    with zipfile.ZipFile(zipped_file, 'w', compression=zipfile.ZIP_DEFLATED) as f:
        f.write(file)

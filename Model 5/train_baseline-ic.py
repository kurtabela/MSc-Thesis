...
import en_ic_dataset

# get_ipython().run_line_magic('cd', 'ic_en_dataset')
os.chdir("en_ic_dataset")
examples, metadata = tfds.load(name="en_ic_dataset:0.0.2", with_info=True,
...
#                                as_supervised=True, data_dir="ic_en_dataset")
# train_examples, val_examples= examples['train'], examples['validation']
...
#         tf.print(tokenizers.en.detokenize(real))
        mask = tf.math.logical_not(tf.math.equal(real, 0))
